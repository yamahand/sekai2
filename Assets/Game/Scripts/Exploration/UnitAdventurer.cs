...
namespace Game.Scripts.Exploration
{
    public class UnitAdventurer : MonoBehaviour, IUnit
    {
        ...
        // セットアップ
        public void Setup(UnitType type, string name, Vector2Int _, Map map)
        {
            this.unitType = type;
            this.unitName = name;
        ...
        // 更新
        public void UpdateUnit(float deltaTime, Map map)
        {
        ...
        // 移動
        private async void Move(MapDef.Direction direction, Map map, CancellationToken cancellationToken)
        {
            // 念のため移動できるかの判定
        ...
        // 次に移動する方向を考える
        private MapDef.Direction ThinkNextDirection(Map map)
        {
